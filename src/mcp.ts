...
if (redactsSensitiveInputs) {
  ...
  server.registerTool('hyv_prepare_rebuild', {
    ...
    () => prepareRebuildForMcp(args.draft, args.profile_json, args.reduction_json, args.copy_spec_json, args.capability_json, loadApprovalContext(), args.writing_brief_json, args.recomposition_policy_json),
  ...
  server.registerTool('hyv_apply_rebuild', {
    ...
    () => applyRebuildForMcp(args.task_json, args.response_json, args.profile_json, args.capability_json, loadApprovalContext()),
  ...
  }, async (args) => guardedLifecycle(
    () => finalizeRejectionForMcp(args.artifact_json, args.decision_json, loadApprovalContext()),
