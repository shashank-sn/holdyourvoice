...
Node.js 20 or newer and npm must be installed. Claude Code uses `npm exec --package=@holdyourvoice/hyv@3.5.0 -- hyv mcp` to download the pinned public package and start a local stdio process.
